...
Health.prototype.Schema =
	...
	"<a:example>" +
		...
		"<SupplyActive>true</SupplyActive>" +
	"</a:example>" +
 ...
 */
 Health.prototype.GetSupplyActive = function() {
 	return this.
 };

Health.prototype.SupplyCheck = function() {
	if ((isOwn || isAlly) && ) {
		//RegenRate +=DecayRate
...
Health.prototype.OnTerritoryPositionChanged = function(msg) {
